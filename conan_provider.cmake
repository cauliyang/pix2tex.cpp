# This file is managed by Conan, contents will be overwritten. To keep your
# changes, remove these comment lines, but the plugin won't be able to modify
# your requirements
...
function(detect_arch ARCH)
  ...
  elseif(CMAKE_OSX_ARCHITECTURES MATCHES armv7s)
    set(_ARCH armv7s)
  elseif(CMAKE_SYSTEM_PROCESSOR MATCHES "i686" OR CMAKE_OSX_ARCHITECTURES
                                                  MATCHES i386)
    set(_ARCH x86)
...
function(detect_compiler COMPILER COMPILER_VERSION COMPILER_RUNTIME
  ...
  if(_COMPILER MATCHES MSVC)
    ...
    if(CMAKE_MSVC_RUNTIME_LIBRARY)
      ...
      # Only define compiler.runtime_type when explicitly requested If a
      # generator expression is used, let Conan handle it conditional on
      # build_type
...
function(detect_host_profile output_file)
  ...
  detect_arch(MYARCH)
  detect_compiler(MYCOMPILER MYCOMPILER_VERSION MYCOMPILER_RUNTIME
...
function(conan_version_check)
  ...
  set(multiValueArgs)
  cmake_parse_arguments(CONAN_VERSION_CHECK "${options}" "${oneValueArgs}"
                        "${multiValueArgs}" ${ARGN})
